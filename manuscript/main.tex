...
\begin{titlepage}
    ...
    \vspace{2cm}
    {\Large\bfseries Dinámicas de la sequía en Paraguay y su vínculo con el calentamiento global: Un análisis espacio-temporal (2000-2023)}\par % TÍTULO DE TESIS
    \vspace{2cm}
...
\fbox{\parbox[b]{0.9\linewidth}{ 
    ...
    \textit{Vargas Ojeda, Hernán Javier}\vspace{0.2cm}\\
     Dinámicas de la sequía en Paraguay y su vínculo con el calentamiento global: Un Análisis Espacio-Temporal (2000-2023) / Hernán J. Vargas Ojeda. – San Lorenzo: Universidad Nacional de Asunción. Facultad de Ciencias Exactas y Naturales, 2026.\vspace{0.2cm}\\ 
    % número de páginas final;
    66 h.; 30 cm.\vspace{0.2cm}\\
...
\noindent\textbf{Palabras clave:} sequía, cambio climático, SPEI, datos de panel, series de tiempo.
\clearpage
