...
Para resolver el problema de la variabilidad espacial de la sequía de manera objetiva, es necesario superar la división regional clásica de Paraguay (Región Oriental y Región Occidental). Las divisiones político-administrativas o fisiográficas tradicionales no siempre se corresponden de manera exacta con los patrones meteorológicos y de balance hídrico dinámicos. 
