...
\begin{itemize}
    ...
    \item $R_i$ es la variable dicotómica que identifica la región geográfica o clúster al que pertenece la base $i$.
    \item $u_{it} = \alpha_i + \varepsilon_{it}$ es el término de error compuesto, donde $\alpha_i$ representa el efecto específico individual no observado de la base $i$ y $\varepsilon_{it}$ representa el error idiosincrático.
\end{itemize}
