...
\begin{enumerate}
    \item La estructuración de una base de datos en formato de panel a partir de los registros diarios de la red oficial de monitoreo terrestre permitió conformar una muestra altamente consistente de 18 estaciones meteorológicas balanceadas para un período continuo de 24 años. La aplicación de un algoritmo de imputación térmica por capas jerárquicas y la política de no imputación para la variable de precipitación garantizaron la consistencia física de la serie temporal agregada mensual ($N \times T = 5094$ observaciones).
