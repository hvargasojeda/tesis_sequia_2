...
\subsection{Nota sobre la nomenclatura numérica}

De acuerdo con las recomendaciones de la Real Academia Española (RAE) para el ámbito científico y tecnológico, y con el propósito de preservar la consistencia con las salidas de los entornos computacionales y softwares estadísticos empleados en esta investigación, en este documento se adopta la nomenclatura científica internacional para la presentación de datos numéricos. Consecuentemente, se utiliza el punto (.) como indicador de separación decimal y la coma (,) como separador de miles.