...
Una vez definidas las regiones homogéneas, el análisis de tendencias se aborda mediante modelos de datos de panel, adecuados para estructuras que combinan variación temporal y espacial. Esta estrategia permite aprovechar simultáneamente la información longitudinal de cada estación o región y las diferencias entre unidades. El análisis de datos de panel, o datos longitudinales, proporciona el marco de inferencia estadística adecuado para aislar y resolver este problema \citep{wooldridge2010}. 
